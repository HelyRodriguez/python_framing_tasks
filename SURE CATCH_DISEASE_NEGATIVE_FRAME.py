...
def create_data_file():
    ...
    f.write('DISEASE Vignette; NEGATIVE Frame; SURE Weighted Catch Trials' + '\n')
...
\n", font=arial20, command=recall_choice_a)
    ...
    button2 = tk.Button(canvas.master, text="B) 33.3% chance that no one will \
die\n and a \n 66.6% chance that everyone will die\
", font=arial20, command=recall_choice_b)
    canvas.create_window(350, 0, window=button2)
    return
...
\n", font=arial20, command=catch_sure_weighted_initiative_a)
    ...
    button2 = tk.Button(canvas.master, text="B) 5% chance that no one will \
die\n and a \n 95% chance that everyone will die\
...
\n", font=arial20, command=catch_initiative_a)
    canvas.create_window(0, -175, window=button1)

    button2 = tk.Button(canvas.master, text="B) 95% chance that no one will \
die\n and a \n 5% chance that everyone will die\
", font=arial20, command=catch_initiative_b)
    canvas.create_window(0, 150, window=button2)
    return
'''
