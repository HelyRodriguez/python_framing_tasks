...
def create_data_file():
    ...
    f.write('DISEASE Vignette; NEGATIVE Frame; GAMBLE Weighted Catch Trials' + '\n')
...
def timer():
    ...
    for x in range(36000):
        my_timer -= (timeit.timeit('time.sleep(0.1)', number=1))*10 #multiplied by 10 so as to subract in deciseconds from 36000 deciseconds
        #sleep(0.1)
        print(my_timer)
        cd_timeline.append(my_timer)
        real_timeline.append((36000 - my_timer)*0.1) #converting deciseconds back to seconds 
        if end:
            break
    return
...
percent chance of everyone dying?', font=style, align='center')
        turtle.hideturtle()
    elif choice == 'B':
        turtle.color('black')
        style = ('Arial', 20, 'bold')
        turtle.write('\
If you had chosen medicine A instead, how many people would not have died?', font=style, align='center')
        turtle.hideturtle()
...
def question4(choice):
    ...
    if choice == 'A':
        ...
        turtle.write('\
If you had chosen medicine B instead, what would be the \n\
percent chance of no one dying?', font=style, align='center')
        turtle.hideturtle()
    elif choice == 'B':
        turtle.color('black')
        style = ('Arial', 20, 'bold')
        turtle.write('\
If you had chosen medicine A instead, how many people would have died?', font=style, align='center')
        turtle.hideturtle()
    while not Q4_answer:
...
def question3(choice):
    ...
    if choice == 'A':
        ...
        style = ('Arial', 20, 'bold')
        turtle.write('\
Based on the medicine you chose, how many people will not die?', font=style, align='center')
        turtle.hideturtle()
    elif choice == 'B':
        turtle.color('black')
        style = ('Arial', 20, 'bold')
        turtle.write('\
Based on the medicine you chose, what is the percent chance that \n\
everyone will die?', font=style, align='center')
        turtle.hideturtle()
...
def question2(choice):
    ...
    if choice == 'A':
        ...
        style = ('Arial', 20, 'bold')
        turtle.write('\
Based on the medicine you chose, how many people will die?', font=style, align='center')
        turtle.hideturtle()
    elif choice == 'B':
        turtle.color('black')
        style = ('Arial', 20, 'bold')
        turtle.write('\
Based on the medicine you chose, what is the percent chance that \n\
no one will die?', font=style, align='center')
        turtle.hideturtle()
...
def question1():
    ...
    style = ('Arial', 20, 'bold')
    turtle.write('\
How many people are at risk of dying from this dangerous new disease?', font=style, align='center')
    turtle.hideturtle()
    ...
    elif Q1_answer and len(Q1_answers) > 0:
        all_cds_rts()
        events.append('Recall Question ' + Q_num)
        trial_types.append(3)
        number = str(1)
...
\n", font=arial20, command=recall_choice_a)
    canvas.create_window(-375, 0, window=button1)

    button2 = tk.Button(canvas.master, text="\
B) 33.3% chance that no one will die\n\
and a \n\
66.6% chance that everyone will die\
", font=arial20, command=recall_choice_b)
    canvas.create_window(345, 0, window=button2)
    return
...
def catch_trial_gamble_weighted():
    turtle.clear()
    button1 = tk.Button(canvas.master, text="\n\
          A) 570 people will die          \
\n", font=arial20, command=catch_gamble_weighted_initiative_a)
    canvas.create_window(0, -175, window=button1)

    button2 = tk.Button(canvas.master, text="\
B) 95% chance that no one will die\n\
and a \n 5% chance that everyone will die\
