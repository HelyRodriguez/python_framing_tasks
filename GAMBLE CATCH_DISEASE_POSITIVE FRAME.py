...
def create_data_file():
    ...
    f.write('DISEASE Vignette; POSITIVE Frame; GAMBLE Weighted Catch Trials' + '\n')
...
def catch_trial_sure_weighted():
    turtle.clear()
    button1 = tk.Button(canvas.master, text="\nA) 570 people will achieve fairness\
...
B) 95% chance that everyone will be saved \n\
and a \n\
...
\n", font=arial20, command=game_initiative_a)
    ...
    button2 = tk.Button(canvas.master, text="\
B) 33.3% chance that everyone will be saved\n\
and a \n\
66.6% chance that no one will be saved\
